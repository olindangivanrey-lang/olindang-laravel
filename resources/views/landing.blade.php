...
<html lang="en">
  <head>
    ...
    <link href="../../../landing-assets/lib/animate/animate.min.css" rel="stylesheet" />
    <link href="../../../landing-assets/lib/lightbox/css/lightbox.min.css" rel="stylesheet" />
  ...
  <body>
    ...
    >
      <a href="index.html" class="navbar-brand p-0">
        <img class="img-fluid me-3" src="../../../landing-assets/img/icon/icon-10.png" alt="Icon" />
        ...
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          <div class="owl-carousel header-carousel">
            <div class="owl-carousel-item">
              <img class="img-fluid" src="../../../landing-assets/img/carousel-1.jpg" alt="" />
            </div>
            <div class="owl-carousel-item">
              <img class="img-fluid" src="../../../landing-assets/img/carousel-2.jpg" alt="" />
            </div>
            <div class="owl-carousel-item">
              <img class="img-fluid" src="../../../landing-assets/img/carousel-3.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-5 gx-4">
          <div
            ...
            data-wow-delay="0.1s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-2.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.3s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-3.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.5s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-4.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.7s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-5.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.1s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-6.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.3s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-7.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.5s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-8.png" alt="Icon" />
          ...
          <div
            ...
            data-wow-delay="0.7s"
          >
            <img class="img-fluid mb-3" src="../../../landing-assets/img/icon/icon-9.png" alt="Icon" />
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-4">
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-assets/img/animal-md-1.jpg" alt="" />
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-assets/img/animal-lg-1.jpg" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="row g-4">
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-assets/img/animal-lg-2.jpg" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-assets/img/animal-md-2.jpg" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="row g-4">
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-assets/img/animal-md-3.jpg" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="../../../landing-starter/img/animal-lg-3.jpg" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
        ...
        <div class="row g-4">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="membership-item position-relative">
              <img class="img-fluid" src="../../../landing-starter/img/animal-lg-1.jpg" alt="" />
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="membership-item position-relative">
              <img class="img-fluid" src="../../../landing-starter/img/animal-lg-2.jpg" alt="" />
      ...
      <div class="container">
        ...
        >
          <div class="testimonial-item text-center">
            <img
              class="../../../landing-assets/img-fluid rounded-circle border border-2 p-2 mx-auto mb-4"
              src="../../../landing-assets/img/testimonial-1.jpg"
          ...
          <div class="testimonial-item text-center">
            <img
              class="../../../landing-assets/img-fluid rounded-circle border border-2 p-2 mx-auto mb-4"
              src="../../../landing-assets/img/testimonial-2.jpg"
              style="width: 100px; height: 100px"
            />
            <div class="testimonial-text rounded text-center p-4">
              <p>
          ...
          <div class="testimonial-item text-center">
            <img
              class="../../../landing-assets/img-fluid rounded-circle border border-2 p-2 mx-auto mb-4"
              src="../../../landing-assets/img/testimonial-3.jpg"
              style="width: 100px; height: 100px"
            />
            <div class="testimonial-text rounded text-center p-4">
              <p>
    ...
    <script src="../../../landing-assets/lib/wow/wow.min.js"></script>
    <script src="../../../landing-assets/lib/easing/easing.min.js"></script>
    <script src="../../../landing-assets/lib/waypoints/waypoints.min.js"></script>
    <script src="../../../landing-assets/lib/counterup/counterup.min.js"></script>
    <script src="../../../landing-assets/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="../../../landing-assets/lib/lightbox/js/lightbox.min.js"></script>
